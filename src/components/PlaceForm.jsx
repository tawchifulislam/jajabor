    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        ...
        <textarea
          ...
          rows={4}
          placeholder="Bus from Chittagong to Khagrachari, then a chander gari..."
          className="w-full rounded-lg border border-line bg-card px-3 py-2 text-ink outline-none focus:border-brand"
        />
      </div>
      ...
      <button
        type="submit"
        disabled={submitting}
        className="w-full rounded-full bg-brand px-6 py-3 font-medium text-white transition hover:opacity-90 disabled:opacity-50"
      >
